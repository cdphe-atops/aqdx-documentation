...
| :-------------------------------- | :------------------------------------------------------------------------- | :-------------------------------------------- | :-------------------------------------------------------------------- |
| [**String (n)**](#string-n)       | Alphanumeric or numeric only text with a maximum length of _n_ characters. | `...,cdphe_apcd_atops,...` <br> `...,008,...` | `{"data_steward_name":"cdphe_apcd_atops"}` <br> `{"unit_code":"008"}` |
